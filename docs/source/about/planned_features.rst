...
.. note::
    ...
    Contribute to the discussion `here <https://github.com/Timoses/Caster/issues/14>`_.
...
.. note::
    ...
    Contribute to the discussion `here <https://github.com/Timoses/Caster/issues/19>`_.
...
.. note::
    ...
    Contribute to the discussion `here <https://github.com/Timoses/Caster/issues/20>`_.
